...
class NewWebViewScreen extends StatefulWidget {
  const NewWebViewScreen({
    super.key,
  });

  @override
  State<NewWebViewScreen> createState() => _NewWebViewScreenState();
}

class _NewWebViewScreenState extends State<NewWebViewScreen> {
...
Page resource error:
  ...
  Widget favoriteButton() {
    return FloatingActionButton(
      onPressed: () async {
        _controller.loadRequest(Uri.parse(
            "https://stackoverflow.com/questions/56200189/how-to-update-webviews-url-on-setstate-flutter"));
        final String? url = "sdfsdfsdf";
        if (context.mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
